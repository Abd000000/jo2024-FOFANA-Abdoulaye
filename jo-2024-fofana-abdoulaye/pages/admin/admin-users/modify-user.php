...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $query = "UPDATE UTILISATEUR SET nom_utilisateur = :nomUtilisateur, prenom_utilisateur = :prenomUtilisateur, login = :loginUtilisateur, password = :password WHERE id_utilisateur = :idUtilisateur";
...
<body>
    ...
    <main>
        ...
        <form action="modify-user.php?id_utilisateur=<?php echo $id_utilisateur; ?>" method="post"
            ...
            <label for="password">Login de l'utilisateur :</label>
